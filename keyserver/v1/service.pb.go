...
const file_keyserver_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x1akeyserver/v1/service.proto\x12\fkeyserver.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"a\n" +
	"\x12GenerateKeyRequest\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x15\n" +
	"\x06org_id\x18\x03 \x01(\tR\x05orgId\"\xcd\x01\n" +
	...
	"\aapi_key\x18\x01 \x01(\tR\x06apiKey\"\xb4\x01\n" +
	...
	"\bdatabase\x18\x05 \x01(\v2\x1d.keyserver.v1.DatabaseDetailsR\bdatabase\"\xde\x01\n" +
...
var file_keyserver_v1_service_proto_depIdxs = []int32{
	9, // 0: keyserver.v1.GenerateKeyResponse.created_at:type_name -> google.protobuf.Timestamp
	6, // 1: keyserver.v1.PutTenantDatabaseRequest.database:type_name -> keyserver.v1.DatabaseDetails
	6, // 2: keyserver.v1.PutTenantDatabaseResponse.database:type_name -> keyserver.v1.DatabaseDetails
	6, // 3: keyserver.v1.ValidateKeyResponse.database:type_name -> keyserver.v1.DatabaseDetails
	0, // 4: keyserver.v1.KeyService.GenerateKey:input_type -> keyserver.v1.GenerateKeyRequest
	2, // 5: keyserver.v1.KeyService.PutTenantDatabase:input_type -> keyserver.v1.PutTenantDatabaseRequest
	4, // 6: keyserver.v1.KeyService.ValidateKey:input_type -> keyserver.v1.ValidateKeyRequest
	7, // 7: keyserver.v1.KeyService.Healthz:input_type -> keyserver.v1.HealthzRequest
	1, // 8: keyserver.v1.KeyService.GenerateKey:output_type -> keyserver.v1.GenerateKeyResponse
	3, // 9: keyserver.v1.KeyService.PutTenantDatabase:output_type -> keyserver.v1.PutTenantDatabaseResponse
	5, // 10: keyserver.v1.KeyService.ValidateKey:output_type -> keyserver.v1.ValidateKeyResponse
	8, // 11: keyserver.v1.KeyService.Healthz:output_type -> keyserver.v1.HealthzResponse
